...
import type { Inquiry as _Inquiry, Time as _Time } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async submitInquiry(arg0: string, arg1: string, arg2: string | null, arg3: string | null, arg4: string, arg5: bigint, arg6: string | null, arg7: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitInquiry(arg0, arg1, to_candid_opt_n5(this._uploadFile, this._downloadFile, arg2), to_candid_opt_n5(this._uploadFile, this._downloadFile, arg3), arg4, arg5, to_candid_opt_n5(this._uploadFile, this._downloadFile, arg6), arg7);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        numTravelers: value.numTravelers,
        travelDates: record_opt_to_undefined(from_candid_opt_n4(_uploadFile, _downloadFile, value.travelDates)),
        fullName: value.fullName,
        email: value.email,
        message: value.message,
        timestamp: value.timestamp,
        phone: record_opt_to_undefined(from_candid_opt_n4(_uploadFile, _downloadFile, value.phone)),
        budgetRange: record_opt_to_undefined(from_candid_opt_n4(_uploadFile, _downloadFile, value.budgetRange))
    };
}
